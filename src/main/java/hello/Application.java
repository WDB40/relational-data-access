...
public class Application implements CommandLineRunner {
    ...
    //changed where the []s were. From args to String. May need to change later
    ...
    public void run(String... strings) throws Exception {
        ...
        List<Object[]> splitUpNames = Arrays.asList("John Woo", "Jeff Dean", "Josh Bloch", "Josh Long", "Wes Brown").stream()
                .map(name->name.split(" "))
